...
//越女剑宫--------------------------------------------------
createPopButton('剑宫', '直通车', YNJGFunc);
function YNJGFunc() { go("jh 50;ne;ne;n;n;n;ne;ne;ne;se;se;se;;s;s;s;s;se;se;e;n;n;n;n;n;n;n;n;w;"); }
...
var items_use = '『秘籍木盒』 兰陵美酒 周年英雄令 周年热血令 神鸢宝箱 茉莉汤 云梦青 『神匠宝箱』冰糖葫芦青凤纹绶 热血印 风云宝箱 腊八粥  腊百草美酒元宵 年糕 高级狂暴丹特级狂暴丹保险卡特级大还丹高级大还丹特级乾坤再造丹高级乾坤再造丹神秘宝箱冰镇酸梅汤';
...
// 杀坏人----------------------------------------------------------------------------------------------------------------
var HongMingNPCList = ["蒙赤行","石幽明","胡铁花","传鹰","星宿恶徒【二】","星宿恶徒【三】","星宿恶徒【四】","[1-5区]段老大", "[1-5区]墟归一", "[1-5区]上官晓芙", "[1-5区]洪昭天","夜魔*恶棍", "夜魔*流寇", "夜魔*剧盗", "夜魔*云老四", "夜魔*岳老三", "夜魔*二娘", "夜魔*段老大", "黑袍公", "独孤须臾", "翼国公", "云观海", "年兽", "铁狼军", "银狼军", "金狼军", "金狼将", "十夫长", "百夫长", "月幽剑士", "濯缨剑士", "对影剑士", "夏花剑士", "[一]镇擂斧将", "[二]镇擂斧将", "天魔真身", "攻楼死士", "镇山神兽", "守山神兽", "应龙幼崽", "应龙兽魂", "应龙分身", "应龙王", "应龙战神", "镇潭神兽", "守潭神兽", "螣蛇幼崽", "螣蛇兽魂", "螣蛇分身", "螣蛇王", "螣蛇战神", "镇殿神兽", "守殿神兽", "幽荧幼崽", "幽荧兽魂", "幽荧分身", "幽荧王", "幽荧战神", "饕餮分身", "饕餮兽魂", "饕餮幼崽", "守谷神兽", "镇谷神兽", "饕餮王", "饕餮战神", "不『二』剑客"];
...
// 杀好人----------------------------------------------------------------------------------------------------------------
var HuangMingNPCList = ["追命","无花","王铁匠", "杨掌柜", "柳绘心", "柳小花", "卖花姑娘", "刘守财", "朱老伯", "方老板", "客商", "方寡妇", "[1-5区]无一", "无一", "铁二","追三", "冷四", "[1-5区]花落云", "[1-5区]辰川", "[1-5区]王世仲", "守楼虎将", "天魔真身", "无『双』公主"];
